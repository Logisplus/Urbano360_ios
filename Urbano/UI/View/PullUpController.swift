...
open class PullUpController: UIViewController {
    ...
    @objc private func handlePanGestureRecognizer(_ gestureRecognizer: UIPanGestureRecognizer) {
        ...
        if heightConstraint!.constant != pullUpControllerPreferredSize.height {
            // actualizar el tamaño del view (si es necesario) de acuerdo al contenido
    ...
    private func setPortraitConstraints(parentViewSize: CGSize) {
        ...
        print("pullUpControllerPreviewOffset: \(pullUpControllerPreviewOffset)")
        print("parentViewSize.width: \(parentViewSize.width)")
        print("parentViewSize.height: \(parentViewSize.height)")
        topConstraint?.constant = parentViewSize.height - 64 - pullUpControllerPreviewOffset
        print("topConstraint?.constant: \(topConstraint?.constant)")
